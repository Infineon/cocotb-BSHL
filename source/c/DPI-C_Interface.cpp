...
//  Author      : See AUTHORS
//  Project     : cocotb-BSHL
//  Description : Interface between System Verilog and C++
...
bool Query_Ext_seq_Test_completion1();
...
int Request_Int_seq_Test_start() {
    // printf("Request Internal sequence\n");
...
void Release_Int_seq_Test_start()
{
    ...
    // printf("Release Internal seq!\n");
}	

int Notify_Int_seq_Test_completion() {
    Int_seq_Test_completion = true;
    // printf("Notifying Internal completion\n");
	return 0;
}

bool Query_Int_seq_Test_completion() 
{
    // printf("Check whether Internal is finished\n");
...
int Request_Ext_seq_Test_start() {
    // printf("Request external sequence\n");
...
bool Query_Ext_seq_Test_completion1() 
{
    // printf("Check whether it is finished\n");
